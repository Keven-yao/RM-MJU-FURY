...
#define SHOOT_2006_PID_KP 10.0f
#define SHOOT_2006_PID_KI 0.2f
#define SHOOT_2006_PID_KD 0.0f
#define SHOOT_2006_PID_MAX_OUT 10000.0f
#define SHOOT_2006_PID_MAX_IOUT 4000.0f
...
void shootInit(void);
void shootTask(void);
void shootSend(u16 shootMotor1, u16 shootMotor2, u16 shootMotor3, u16 shootMotor4);
