...
int16_t setW_S_A_Dspeed;//设置底盘速度系数
...
void chassisConversion(void)//底盘 转换  读取遥控器底盘设置数据
{
	...
	if (Yaw_flag == 1)
	{
		...
		//chassisRotateSpeed = setM1Speed = setM2Speed = setM3Speed = setM4Speed = 3000*Chassis_flag; //默认的自转
...
//	
//	if(KEY_PRESSED_OFFSET_SHIFT & RC_Ctl.key.v )
//  	{	
//		setW_S_A_Dspeed = 2000;
//   	}
	}
