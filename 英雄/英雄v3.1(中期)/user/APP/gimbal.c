...
date:V2.1:2020.2.12 Caden 为新版英雄机器人适配代码，主要修改：
										1）取消小弹丸发射机构
...
#define midPitch 4400         //pitch轴中点位置
...
int16_t yawSpeed,pitchSpeed,rollSpeed,speed=35;//speed=-42											//两轴速度
...
void limitSet(void)//限位     0 ~ 8191   8190/360=22.75
{
	...
	upLimit=		3530;							//  垂直 下限
	downLimit=	4770;							//  垂直 上限 (7500-6830)/22.75=670/22.75=30°C 
...
void angleConversion(void)           //角度 转换    遥控 输入 云台 水平角 俯仰角 数据   
{
	...
	addPitch=inputPitchData*1.0;  //遥控灵敏度  	
/********************************************************************/   //Pitch 6020
//	if(RC_Ctl.rc.s2 == 1)
//	{
//			setPitch=4400;
