...
# define MPU_GYRO_RANGE_250                (0x0 << MPU_GYRO_FS_SEL_SHIFTS)
# define MPU_GYRO_RANGE_500                (0x1 << MPU_GYRO_FS_SEL_SHIFTS)
# define MPU_GYRO_RANGE_1000               (0x2 << MPU_GYRO_FS_SEL_SHIFTS)
# define MPU_GYRO_RANGE_2000               (0x3 << MPU_GYRO_FS_SEL_SHIFTS)
...
# define MPU_ACCEL_RANGE_2G                (0x0 << MPU_ACCEL_FS_SEL_SHIFTS)
# define MPU_ACCEL_RANGE_4G                (0x1 << MPU_ACCEL_FS_SEL_SHIFTS)
# define MPU_ACCEL_RANGE_8G                (0x2 << MPU_ACCEL_FS_SEL_SHIFTS)
# define MPU_ACCEL_RANGE_16G               (0x3 << MPU_ACCEL_FS_SEL_SHIFTS)
