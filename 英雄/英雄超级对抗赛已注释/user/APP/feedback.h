...
typedef struct
{
		int16_t InputVot;								//data[0]-[1]
		int16_t CapVot;										//data[2]-[3]
		int16_t	Test_Current;									//data[4]-[5]
		int16_t Target_Power;											//data[6]
		
}PowerData;

extern PowerData power_data;
extern feedback_data M3508_1,M3508_2,M3508_3,M3508_4,M3508_5,M3508_6,M3508_7,GM6020_Roll,
