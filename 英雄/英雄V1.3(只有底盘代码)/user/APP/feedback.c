...
feedback_data M3508_1,M3508_2,M3508_3,M3508_4,M3508_5,M3508_6,GM6020_Yaw,GM6020_Pitch,M2006_1,M2006_2,GM6020_give,GM6020_Pitch2;;  //定义4个底盘电机和2个云台一共拨弹电机 
...
//            break;
            ...
            break;
//				case 0x207:     //M2006   ID:7   拨弹               发送:0x1ff[4,5]
//            
//							{
...
//            break;
				...
				case 0x209:    //GM6020 ID:5   yaw               发送:0x2ff[0,1]
							{
					  ...
					  break;
				case 0x20a:    //GM6020 ID:6   pitch1               发送:0x2ff[2,3]
            ...
            break;
				case 0x20b:    //GM6020 ID:7    pitch2               发送:0x2ff[4,5]
       
							{
								GM6020_Pitch2.Mechanical_angle = RxMessage.Data[0]<<8|RxMessage.Data[1];
								GM6020_Pitch2.Rotor_speed = RxMessage.Data[2]<<8|RxMessage.Data[3];
								GM6020_Pitch2.Torque_current = RxMessage.Data[4]<<8|RxMessage.Data[5];
								GM6020_Pitch2.Temperature = RxMessage.Data[6];
							}
            break;
