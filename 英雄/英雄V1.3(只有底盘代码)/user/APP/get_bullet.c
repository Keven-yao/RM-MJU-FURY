...
//	
//          
//    MotorData[0] = set2006_output >> 8;  
//    MotorData[1] = set2006_output & 0xFF;   
//		MotorData[2] = set2006_output_f >> 8;
//    MotorData[3] = set2006_output_f & 0xFF;
		
//		CAN1_Send_Msg(0x200, MotorData, 0x02);
	
	
	
//	  printf("%d \r\n",now3508_Angle);
//		USART6_TX_Byte(now3508_Angle>>24);
//		USART6_TX_Byte(now3508_Angle>>16);
//		USART6_TX_Byte(now3508_Angle>>8);
//		USART6_TX_Byte(now3508_Angle);
